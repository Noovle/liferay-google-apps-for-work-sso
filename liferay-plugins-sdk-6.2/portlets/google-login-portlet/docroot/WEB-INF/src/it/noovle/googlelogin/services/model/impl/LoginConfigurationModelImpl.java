...
public class LoginConfigurationModelImpl extends BaseModelImpl<LoginConfiguration>
	...
	public static final String TABLE_SQL_CREATE = "create table google_login_LoginConfiguration (companyId LONG not null primary key,clientId VARCHAR(2000) null,clientSecret VARCHAR(2000) null,createUserOnLogin BOOLEAN,doRedirect BOOLEAN,doRedirectAfter LONG,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table google_login_LoginConfiguration";
	public static final String ORDER_BY_JPQL = " ORDER BY loginConfiguration.companyId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY google_login_LoginConfiguration.companyId ASC";
