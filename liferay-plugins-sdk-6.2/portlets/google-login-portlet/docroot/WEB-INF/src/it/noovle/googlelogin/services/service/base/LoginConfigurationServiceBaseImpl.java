...
/**
 * Provides the base implementation for the login configuration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.noovle.googlelogin.services.service.impl.LoginConfigurationServiceImpl}.
 * </p>
 *
 * @author
 * @see it.noovle.googlelogin.services.service.impl.LoginConfigurationServiceImpl
 * @see it.noovle.googlelogin.services.service.LoginConfigurationServiceUtil
 * @generated
 */
public abstract class LoginConfigurationServiceBaseImpl extends BaseServiceImpl
	implements LoginConfigurationService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.noovle.googlelogin.services.service.LoginConfigurationServiceUtil} to access the login configuration remote service.
	 */
	 ...
	 */
	public it.noovle.googlelogin.services.service.LoginConfigurationLocalService getLoginConfigurationLocalService() {
	...
	public void setLoginConfigurationLocalService(
		it.noovle.googlelogin.services.service.LoginConfigurationLocalService loginConfigurationLocalService) {
	 ...
	 */
	public it.noovle.googlelogin.services.service.LoginConfigurationService getLoginConfigurationService() {
	...
	public void setLoginConfigurationService(
		it.noovle.googlelogin.services.service.LoginConfigurationService loginConfigurationService) {
	...
	@BeanReference(type = it.noovle.googlelogin.services.service.LoginConfigurationLocalService.class)
	protected it.noovle.googlelogin.services.service.LoginConfigurationLocalService loginConfigurationLocalService;
	@BeanReference(type = it.noovle.googlelogin.services.service.LoginConfigurationService.class)
	protected it.noovle.googlelogin.services.service.LoginConfigurationService loginConfigurationService;
	...
	private LoginConfigurationServiceClpInvoker _clpInvoker = new LoginConfigurationServiceClpInvoker();
}